...
function spriteVsMovinPlatform(mage, platForm) {
    //mage.body.y -= platForm.body.y - platForm.body.prev.y;
    //mage.body.y = platForm.body.y - platForm.body.prev.y;
...
PlayState._handleCollisions = function() {
    ...
    this.game.physics.arcade.overlap(mage, this.coins, this._onHeroVsCoin,
        null, this);
    this.physics.arcade.collide(mage, movingGrasseY, spriteVsMovinPlatform, null, this);
};
