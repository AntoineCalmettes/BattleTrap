...
mageChoose.addEventListener("click", () => {
    ...
    historyPerso.innerHTML=" Largement considéré comme l'un des plus puissants sorciers de Runeterra, Ce mage est un archimage endurci par les ans qui porte un fardeau incommensurable sur ses épaules. Armé d'une constitution à toute épreuve et d'un vaste arsenal de connaissances mystiques, il consacre sa vie à rassembler les Runes telluriques, les fragments de magie brute qui ont jadis servi à façonner le monde.";
...
voleurChoose.addEventListener("click", () => {
    ...
    historyPerso.innerHTML=" On dit que la mort n'est pas drôle. C'est vrai, à moins que vous ne soyez ce voleur ; là, elle est hilarante. C'est le premier comique meurtrier en activité de Valorane. Celui qu'on appelle le voleur des ténèbres est une énigme. Personne de vivant ne sait d'où il vient, lui-même n'en parle jamais à personne. Les rumeurs disent qu'il n'est pas de Runeterra, qu'il est un être originaire d'un monde sombre et difforme.";
